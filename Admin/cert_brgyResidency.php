                ...
                <!-- END CERTIFICATE SIDEBAR -->
                  ...
                  <div class="col-8">
                    <!-- BACKGROUND LOGO -->
                      ...
                      <h4 class="text-center mt-5 mb-3">CERTIFICATION</h4>

                      <p class="text-sm m-0" style="text-indent: 30px; text-align: justify;">This is to certify that <b><?php echo ' '.$row['firstname'].' '.$row['middlename'].' '.$row['lastname'].' '.$row['suffix'].' '; ?></b> of legal age, a bonafide resident of Barangay 193 Zone 20 with present address at <?php echo ' '.$row['house_no'].' '.$row['street_name'].' '.$row['purok'].' '.$row['zone'].' '.$row['barangay'].' '.$row['municipality'].' '.$row['province'].' '.$row['region'].' '; ?>.</p>
                      <br>
