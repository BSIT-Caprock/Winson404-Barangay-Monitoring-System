        ...
        <div class="row d-flex justify-content-center">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 col-12">
            <div class="small-box card">
              <div class="inner">
                <h5 class="text-center mt-4 p-2">Permits</h5>
              </div>
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 col-12">
            <div class="small-box card">
              <div class="inner">
                <h5 class="text-center mt-4 p-2">Non-Residency Certificate</h5>
              </div>
              <a href="#" class="small-box-footer text-dark">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 col-12">
            <div class="small-box card">
              <div class="inner">
                <h5 class="text-center mt-4 p-2">Barangay Business Clearance</h5>
              </div>
              <a href="#" class="small-box-footer text-dark">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 col-12">
            <div class="small-box card">
              <div class="inner">
                <h5 class="text-center mt-4 p-2">Business Plate</h5>
              </div>
              <a href="#" class="small-box-footer text-dark">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-sm-6 col-12">
            <div class="small-box card">
              <div class="inner">
                <h5 class="text-center mt-4 p-2">Barangay ID Card</h5>
              </div>
              <a href="#" class="small-box-footer text-dark">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
