...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 03, 2023 at 07:29 AM
...
(69, 'Juan', 'Panday', 'Dela Cruz', '', '1997-10-15', '25 years old', 'Adult', 'bvcbcb', 'Female', 'Separated', 'Naturalization', 'bvcbc', 'Ang Dating Daan', 'bvc', 'bcvbcb', 'vcbcb', 'vcbcv', 'bcvbc', 'bcvbcvbcv', 'bvc', 'bvcbc', 'Solo Parents', 'Tempo/Rented', 'Active', 'None', 'Active', '343', 'Screenshot (193).png', 'Screenshot (188).png', '../images-qr-codes/63a70b9feddb2.png', '', '', '2022-11-25'),
...
--
ALTER TABLE `documents`
MODIFY `doc_Id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=95;
--
-- AUTO_INCREMENT for table `income`
--
ALTER TABLE `income`
MODIFY `incomeId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=86;
--
